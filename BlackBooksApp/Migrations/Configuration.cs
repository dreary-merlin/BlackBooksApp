namespace BlackBooksApp.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BlackBooksApp.DAL.BookshopContext>
    {
        ...
        protected override void Seed(BlackBooksApp.DAL.BookshopContext context)
        {
            ...
            types.ForEach(s => context.Types.AddOrUpdate(p => p.Category, s));
            context.SaveChanges();
            ...
            publhouses.ForEach(s => context.PublishingHouses.AddOrUpdate(p => p.Name, s));
            context.SaveChanges();
            ...
            deliveries.ForEach(s => context.Deliveries.AddOrUpdate(p => p.Name, s));
            context.SaveChanges();
            ...
            employees.ForEach(s => context.Employees.AddOrUpdate(p => p.Phone, s));
            context.SaveChanges();
            ...
            clients.ForEach(s => context.Clients.AddOrUpdate(p => p.Phone, s));
            context.SaveChanges();
            ...
            orders.ForEach(s => context.Purchases.AddOrUpdate(p => p.Id, s));
            context.SaveChanges();
            ...
            ordered.ForEach(s => context.PurchasedBooks.AddOrUpdate(p => p.Id, s));
            context.SaveChanges();
        }
    }
}
